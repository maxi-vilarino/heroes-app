  ...
  return (
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50">
      <div className="relative h-64 overflow-hidden">
        ...
        {/* Universe badge */}
        {hero.universe === 'DC' ? (<Badge className="absolute top-3 right-3 text-xs bg-blue-600 text-white">
          {hero.universe}
        </Badge>) : (<Badge className="absolute top-3 right-3 text-xs bg-teal-600 text-white">
          {hero.universe}
        </Badge>)}
